...
use crate::{id_alox, id_serde, Path, RpgOption, Table2};
...
pub struct Actor {
    ...
    pub armor1_id: RpgOption<usize>,
    pub armor2_id: RpgOption<usize>,
    pub armor3_id: RpgOption<usize>,
    pub armor4_id: RpgOption<usize>,
    pub weapon_fix: bool,
    pub armor1_fix: bool,
    pub armor2_fix: bool,
    pub armor3_fix: bool,

...
impl Cache {
    ...
    pub fn setup_defaults(&self) {
        ...
        *self.state.borrow_mut() = State::Loaded {
            actors: AtomicRefCell::new(vec![rpg::Actor::default()]),
            animations: AtomicRefCell::new(vec![rpg::Animation::default()]),
            armors: AtomicRefCell::new(vec![rpg::Armor::default()]),
            classes: AtomicRefCell::new(vec![rpg::Class::default()]),
            common_events: AtomicRefCell::new(vec![rpg::CommonEvent::default()]),
            enemies: AtomicRefCell::new(vec![rpg::Enemy::default()]),
            items: AtomicRefCell::new(vec![rpg::Item::default()]),
            skills: AtomicRefCell::new(vec![rpg::Skill::default()]),
            states: AtomicRefCell::new(vec![rpg::State::default()]),
            tilesets: AtomicRefCell::new(vec![rpg::Tileset::default()]),
            troops: AtomicRefCell::new(vec![rpg::Troop::default()]),
            weapons: AtomicRefCell::new(vec![rpg::Weapon::default()]),
